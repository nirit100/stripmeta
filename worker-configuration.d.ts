/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f07355435992d3e8198413fbec94276f)
// Runtime types generated with workerd@1.20260603.1 2026-06-08 
interface __BaseEnv_Env {
	EMAIL: SendEmail;
	PUBLIC_KOFI_URL: string;
	PUBLIC_KOFI_ID: string;
	PUBLIC_PAYPAL_URL: string;
	PUBLIC_GITHUB_URL: string;
	PUBLIC_PRIVACY_URL: string;
	PUBLIC_IMPRESSUM_URL: string;
